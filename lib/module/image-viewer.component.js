...
import { Animated, CameraRoll, I18nManager, Image, Text, TouchableHighlight, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
...
export default class ImageViewer extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "state", new State());

    _defineProperty(this, "fadeAnim", new Animated.Value(0));

    _defineProperty(this, "standardPositionX", 0);

    _defineProperty(this, "positionXNumber", 0);

    _defineProperty(this, "positionX", new Animated.Value(0));

    _defineProperty(this, "width", 0);

    _defineProperty(this, "height", 0);

    _defineProperty(this, "styles", styles(0, 0, 'transparent'));
    ...
    _defineProperty(this, "handleLayout", event => {
      if (event.nativeEvent.layout.width !== this.width) {
        ...
        this.styles = styles(this.width, this.height, this.props.backgroundColor || 'transparent'); // 强制刷新
  ...
  getContent() {
    ...
    const ImageElements = this.props.imageUrls.map((image, index) => {
      ...
      const Wrapper = ({
        children,
        ...others
      }) => /*#__PURE__*/React.createElement(ImageZoom, _extends({
  ...
  render() {
    let childs = null;
    childs = /*#__PURE__*/React.createElement(View, {
      style: {
        flex: 1,
        height: '100%'
      }
...
_defineProperty(ImageViewer, "defaultProps", new Props());
